...
namespace PASS2
{
    ...
    public class Point
    {
        ...
        //Post: None.
        //Description: This constructor sets the private variables 'x' and 'y' to what the user inputted via the auto-implemented properties (doing it this way calls the set methods)
